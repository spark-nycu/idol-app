...
"
 ...
 Please reply warmly and positively to the fan's message: "${message}"` }],
    ...
    const prompts = {
      happy: 'Positive expression with a pleasant smile. Retain original facial features and identity. Chinese face',
    ...
    const inPaintingParams = { 
      ...
      maskPrompt: 'face', 
      text: inpaintPrompt, 
      negativeText: 'distorted, horror, deformed, ugly face, small eye, wrinkle, pale face, big nostril' 
    };
